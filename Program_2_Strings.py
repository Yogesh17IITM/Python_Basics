...
print(s[1:5]) #print charaters from index 1 to 5
print(s[1:5:1]) #print charaters from index 1 to 5
print(s[:3]) #printing characters till index 3
print(s[5:]) #printing all characters starting from index 5
print(s[::3]) #printing characters with every 3 intervals
print(s[2:10:2]) #printing from 2nd index to 10th index at every 2 intervals
